...
const ListLayout: React.FC<IListLayoutProps> = ({
  ...
  return (
    <div className={`${styles.listContainer} ${styles[cardAlignment || 'center']}`} style={containerStyle}>

      {linkItems.map((link, index) => (
        <div
          key={link.Id}
          className={`${styles.listItem} ${!link.Icon ? styles.textOnly : ''}`}
          style={{
        ...
        >
          ...
          >
            ...
            >
              <div className={styles.listContent} style={{ ...getBorderRadiusStyle(link),
                // ...getCardStyle(link),
                    ...
                    <div className={styles.listIconWrapper}>
                      {link.Icon.startsWith('http') ? (
                        ...
                        <Icon
                          ...
                          className={styles.listFluentIcon}
