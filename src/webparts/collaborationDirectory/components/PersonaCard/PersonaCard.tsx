...
> {
  ...
  private _PersonaCard(): JSX.Element {
   const numberOfCards = this.props.numberOfCards || 1;
    return (
     <DocumentCard 
      className={`${styles.documentCard} ${styles.oneCard}`}  // Always apply .oneCard
      type={DocumentCardType.normal}
      data-number={numberOfCards}  // Data attribute as condition to change width
    >
