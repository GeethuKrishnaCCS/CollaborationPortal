...
export interface IBaseService {
    ...
    getExtPagedListItems(queryurl: string): Promise<any>;
    getItemsExtSelectFilterExpand(queryurl: string, select: string, filter: string, expand: string): Promise<any>;
    getItemsExtSelectFilter(queryurl: string, select: string, filter: string): Promise<any>;
    getItemsExtFilter(queryurl: string, filter: string): Promise<any>;
    ...
    getExtItemsSelect(queryurl: string, select: string): Promise<any>;
    ...
    getExtListItems(url: string): Promise<any>;
